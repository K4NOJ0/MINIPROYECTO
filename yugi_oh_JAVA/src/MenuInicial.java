    ...
    public MenuInicial() {
        ...
        JPanel panel = new JPanel() {
            ...
            protected void paintComponent(Graphics g) {
                ...
                GradientPaint gp = new GradientPaint(0, 0, new Color(10, 5, 30),
        ...
        gbc.gridx = 0; gbc.gridy = 0; gbc.insets = new Insets(10,20,5,20);
        ...
        gbc.gridy = 2; gbc.insets = new Insets(30,20,5,20);
        ...
        gbc.gridy = 4; gbc.insets = new Insets(15,20,5,20);
        JLabel lbl2 = new JLabel("Nombre del Duelista 2:");
        lbl2.setFont(new Font("Serif", Font.BOLD, 16));
        lbl2.setForeground(Color.WHITE);
        panel.add(lbl2, gbc);

        gbc.gridy = 5; gbc.insets = new Insets(5,20,5,20);
        JTextField campo2 = createStyledField("SHINRA");
        panel.add(campo2, gbc);

        gbc.gridy = 6; gbc.insets = new Insets(30,20,20,20);
        JButton btnDuelar = createGoldButton("⚔  ¡COMENZAR DUELO!  ⚔");
        btnDuelar.addActionListener(e -> {
            String n1 = campo1.getText().trim();
            String n2 = campo2.getText().trim();
            if (n1.isEmpty()) n1 = "DUELISTA 1";
            if (n2.isEmpty()) n2 = "DUELISTA 2";
            dispose();
            new TableroJuego(n1, n2).setVisible(true);
        });
        ...
        JButton btn = new JButton(text) {
            ...
            protected void paintComponent(Graphics g) {
                ...
                if (getModel().isPressed()) {
                    ...
                    g2.setColor(new Color(230, 190, 60));
                } else {
