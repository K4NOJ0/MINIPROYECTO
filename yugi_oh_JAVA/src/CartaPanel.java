...
/**
 * PARTE 2 — VISTA PURA
 * CartaPanel es responsable únicamente de PINTAR una carta.
 * No toma ninguna decisión de juego.
 * El Controlador adjunta los MouseListeners externamente.
 */
public class CartaPanel extends JPanel {
    ...
    // ── Paleta de colores (solo visuales) ───────────────────────────────────
    ...
    // ── Tooltip HTML (solo información, sin llamadas a lógica) ───────────────
