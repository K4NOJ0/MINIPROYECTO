...
public class CartaPanel extends JPanel {
    ...
    private static final int W = 80, H = 110;
    ...
    public void setSeleccionada(boolean v) {
        this.seleccionada = v;
        repaint();
    }
    ...
    private String buildTooltip() {
        ...
        StringBuilder sb = new StringBuilder("<html><b>" + carta.getNombre() + "</b><br/>");
        sb.append("Tipo: ").append(carta.getTipo()).append("<br/>");
        sb.append(carta.getDescripcion()).append("</html>");
        return sb.toString();
    }
    ...
    protected void paintComponent(Graphics g) {
        ...
        Color borderColor = seleccionada ? GOLD_LIGHT : GOLD;
        ...
        drawWrappedString(g2, nombre, 5, 38 + yOff, w - 10, 9);
